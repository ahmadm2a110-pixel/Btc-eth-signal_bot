...
""".strip()
            ...
            await send_ntfy(
                f"{symbol} — "
                f"H1 BREAKOUT CONFIRMED",
                message,
                "default",
            )

            logger.info(
                f"{symbol} | H1 breakout "
                f"confirmed | {direction} | "
                f"M15 watch activated"
            )
