...
# Breakout / retest
BREAKOUT_MIN_DISTANCE_ATR = 0.0
RETEST_ATR_TOLERANCE = 0.35
MAX_M15_WAIT_CANDLES = 32
    ...
    if downline:
        ...
        if c1["close"] > level:
            ...
            candidates.append({
                ...
                "candle": c1,
                "structure":
                    "H1_DOWNTRENDLINE_BROKEN",
            })

    # ========================================================
    # SHORT — UP TRENDLINE BREAK
    # ========================================================
...
async def process_existing_setup(
    symbol,
    m15_df,
):
...
async def scan_symbol(
    ...
    try:
        ...
        # ====================================================
        # CHECK EXISTING M15 SETUP FIRST
        # ====================================================
        ...
        # ====================================================
        # IMPORTANT:
        # SAME H1 BREAKOUT MUST NOT BE PROCESSED AGAIN
        # ====================================================
        ...
        # ====================================================
        # CREATE M15 WATCH DIRECTLY
        #
        # NO CANDLE 2
        # NO H1 SECOND CANDLE
        # NO SECOND CANDLE CONFIRMATION
        # ====================================================
        ...
        message = f"""
{emoji} {symbol} — H1 BREAKOUT DETECTED
...
Candle 2 confirmation is NOT used.
""".strip(),
            "default",
        )
